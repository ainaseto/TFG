...
x_all = np.load('/Users/aina/Desktop/TFG/codi/embeddings/embeddings_multilayer.npy')
...
millor_model = None
millor_recall_pos = 0.0
millor_dif_recall = 0.0
for i in range(10):
...
t1 = time.time()
print(t1-t0)
torch.save(gcn.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/multilayer/gin.pt')
...
t1 = time.time()
print(t1-t0)
torch.save(gcn.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/multilayer/gat.pt')
