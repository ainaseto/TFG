import numpy as np
import random
import metriques_monoplex as monoplex

adj_all = np.load('/Users/aina/Desktop/TFG/codi/xarxes/monoplex.npy') # (270, 76, 76)
...
print(f"Calen {num_sintetics} grafs nous")
...
for metrica in lst_metrics:
    monoplex.get_metric_values(matrius_adj,  metrics_folder = "/Users/aina/Desktop/TFG/codi/metriques/smote/monoplex", METRIC=metrica)

np.save("xarxes/smote/monoplex.npy", matrius_adj)
