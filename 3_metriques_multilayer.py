...
def get_metric_values(em, METRIC=None):
    ...
    num_nodes = 76
    metrics_folder = "/Users/aina/Desktop/TFG/codi/metriques/multilayer"
    ...
    for i in range(num_subjs):
        ...
        try:
            if METRIC=='Degree':
                ...
                A_min = Functions.compute_A_min(A_inv) # Compute A min               
                ...
                A_min = Functions.compute_A_min(A_inv) 
...
multilayer = np.load("xarxes/multilayer.npy")
