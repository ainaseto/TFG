...
#--------------------------------------------------------------------------------------------------------------------------------------------------  
adj_all = np.load('/Users/aina/Desktop/TFG/codi/xarxes/monoplex.npy')
print(f"Mida de adj_all: {adj_all.shape}")  # (270, 152, 152)

x_all = np.load('/Users/aina/Desktop/TFG/codi/embeddings/embeddings_monoplex.npy')
...
t1 = time.time()
print(t1-t0)
#torch.save(gcn.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/monoplex/gin.pt')
...
t1 = time.time()
print(t1-t0)
torch.save(gcn.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/monoplex/gat.pt')
