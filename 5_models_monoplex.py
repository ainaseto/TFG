...
#--------------------------------------------------------------------------------------------------------------------------------------------------  
adj_all_real = np.load('/Users/aina/Desktop/TFG/codi/xarxes/monoplex.npy')
print(f"Mida de adj_all_real: {adj_all_real.shape}")  # (270, 76, 76)
adj_all_sintetic = np.load('/Users/aina/Desktop/TFG/codi/xarxes/smote/monoplex.npy')
print(f"Mida de adj_all_sintetic: {adj_all_sintetic.shape}")  # (128, 76, 76)
adj_all = np.concatenate([adj_all_real, adj_all_sintetic], axis=0)
print(f"Mida de adj_all: {adj_all.shape}")  # (398, 76, 7)

x_all_real = np.load('/Users/aina/Desktop/TFG/codi/embeddings/embeddings_monoplex.npy')
print(f"\nMida de x_all_real: {x_all_real.shape}")  # (270, 76, 7)
x_all_sintetic = np.load('/Users/aina/Desktop/TFG/codi/embeddings/smote/embeddings_monoplex.npy')
...
t1 = time.time()
print(t1-t0)
torch.save(gcn.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/monoplex/gcn.pt')
...
plt.legend()
plt.tight_layout()
plt.savefig('/Users/aina/Desktop/TFG/codi/resultats/monoplex/gcn_loss.png', dpi=300, bbox_inches='tight')
plt.show()
...
t1 = time.time()
print(t1-t0)
torch.save(gin.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/monoplex/gin2.pt')
...
plt.legend()
plt.tight_layout()
plt.savefig('/Users/aina/Desktop/TFG/codi/resultats/monoplex/gin_loss.png', dpi=300, bbox_inches='tight')
plt.show() 
...
t1 = time.time()
print(t1-t0)
torch.save(gat.state_dict(), f'/Users/aina/Desktop/TFG/codi/resultats/monoplex/gat.pt')
...
plt.legend()
plt.tight_layout()
plt.savefig('/Users/aina/Desktop/TFG/codi/resultats/monoplex/gat_loss.png', dpi=300, bbox_inches='tight')
plt.show()
